...
export default function SmartSidebar() {
  ...
  const adminMenuItems = [
    ...
    { href: '/admin/verification', icon: 'fas fa-check-circle', label: 'Verifikasi Barang' },
    ...
    { href: '/admin/display', icon: 'fas fa-star', label: 'Manage Display' },
    { href: '/admin/payment', icon: 'fas fa-credit-card', label: 'Fitur Pembayaran' }
  ]
  ...
  const resellerMenuItems = [
    ...
    { href: '/reseller/calculator', icon: 'fas fa-calculator', label: 'Kalkulator Profit' },
